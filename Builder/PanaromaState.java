...
public class PanaromaState implements State {
	
	CameraStates cameraStates;
	public PanaromaState(CameraStates cameraStates) {
	...
	public void Panaroma() {
		...
		cameraStates.setState(cameraStates.getNewCameraState());
